<!-- AnnouncementEdit.vue (UPDATED: sidebar removed — using global sidebar from App.vue) -->
<template>
  <div class="page tech">
...
async function onSubmit() {
  ...
  try {
    ...
    if (saved) {
      ...
      existing.imageUrl = String(saved.image_url || saved.imageUrl || "").trim() || toAbsUrlMaybe(existing.imageRel);
...
/* Layout (sidebar removed => 1 column) */
.layout {
  display: grid;
