      ...
      <section class="content">
        <header ref="headEl" class="head js-reveal">
          <div class="headLeft">
            ...
            <div>
              <div class="title">ຮ່ວມງານກັບເຮົາ</div>
              <div class="sub">LAPNet ຕ້ອງການເພື່ອນຮ່ວມງານ</div>
            </div>
          </div>
        ...
        <section ref="cardEl" class="card js-card">
          <div class="cardTop">
            <div class="cardTitle"><i class="fa-solid fa-user-plus"></i> Job Post Information</div>
              ...
              <div class="bulletPanel js-reveal">
                ...
                <ul v-if="form.bullets.length" class="dotList">
                  <li v-for="(b, idx) in form.bullets" :key="idx">
                    ...
                    <button class="xBtn" type="button" @click="removeBullet(idx)" title="Remove">
