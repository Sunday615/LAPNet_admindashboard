...
<!-- ✅ NO SIDEBAR: Sidebar is handled in App.vue -->
<template>
  <div class="page tech">
...
onMounted(() => {
  ...
  // ✅ No sidebar animation (sidebar is in App.vue)
  gsap.set(".js-card", { opacity: 0, y: 14, scale: 0.985 });
  gsap.set(".js-reveal", { opacity: 0, y: 10 });

  const tl = gsap.timeline({ defaults: { ease: "power3.out" } });
  tl.to(".js-card", { opacity: 1, y: 0, scale: 1, duration: 0.55 }, 0).to(".js-reveal", { opacity: 1, y: 0, stagger: 0.06, duration: 0.45 }, 0.12);
