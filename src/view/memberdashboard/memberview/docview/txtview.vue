            ...
            <table class="wordTable">
              ...
              <tbody v-if="excelDocs.length">
                ...
                >
                  <td>
                    <div class="wIcon">
                      <img src="/document_icon/txt.png" alt="" />
                    </div>
                  </td>
...
const documents = ref([
  ...
  { key: "p1", name: "Narrative-Report.txt", size: 580000, updatedAt: "2026-01-10T08:00:00Z", owner: "John", tags: ["PDF"], path: "/pdf/Narrative-Report.txt" },
